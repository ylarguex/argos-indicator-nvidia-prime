...
notify_switch="notify-send -h int:transient:2 \\\"dialog-information-symbolic\\\" \\\"NVidia Prime Indicator\\\" \\\"Switching graphics. Please logout to finalize process! \\\" ; "
...
echo "---"
echo "Switch to INTEL :: LOGOUT | iconName='prime-indicator-intel' bash=$activate_intel terminal=false"
echo "Switch to NVIDIA :: LOGOUT | iconName='prime-indicator-nvidia' bash=$activate_nvidia  terminal=false"
echo "---"
